#define display_mouse_lock_init
global.__display_mouse_bounds__buf = undefined;
display_mouse_lock_init_raw(window_handle());

#define display_mouse_lock_auto
return display_mouse_lock(window_get_x(), window_get_y(), window_get_width(), window_get_height());
